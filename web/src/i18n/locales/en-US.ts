export default {
    meta: {
        title: "AI Canvas",
        description: "An AI canvas creation tool",
    },
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", referenceMode: "Reference scenario", referenceModes: { reference: "Multi-image reference", firstFrame: "Image-to-video (first frame)", firstLastFrame: "Image-to-video (first + last frame)" }, referenceModeHints: { reference: "All attached reference images are used together as an omni multi-image reference (up to 9).", firstFrame: "Only the 1st reference image is used as the video's first frame; any others are ignored.", firstLastFrame: "The 1st reference image is used as the first frame and the 2nd as the last frame; any others are ignored." }, sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    canvas: {
        ...
        backToProjects: "Back to My Canvases",
        ...
        export: { defaultProjectName: "AI Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>AI Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by AI Canvas, grouped by object store.",
