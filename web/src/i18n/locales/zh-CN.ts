export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", referenceMode: "参考图场景", referenceModes: { reference: "多图参考", firstFrame: "图生视频·首帧", firstLastFrame: "图生视频·首尾帧" }, referenceModeHints: { reference: "所有参考图作为多图参考（omni reference）一起生效，最多 9 张。", firstFrame: "仅使用第 1 张参考图作为视频首帧，其余参考图会被忽略。", firstLastFrame: "使用第 1 张参考图作为首帧、第 2 张作为末帧，其余参考图会被忽略。" }, sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    canvas: {
        ...
        export: { defaultProjectName: "AI画布", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>AI画布</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "查看 AI画布 在浏览器中保存的数据量，并按对象仓库统计内容体积。",
